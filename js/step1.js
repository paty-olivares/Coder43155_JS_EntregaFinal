...
//Agregando toastify a los botones
...
const resultado = () => {
  ...
  Toastify({
    text: "El total de su Compra es MXN $" + `${localStorage.getItem("GrandTotalCompra")}`,
    duration: 3000,
    newWindow: true,
    close: true,
    ...
    style: {
      background: "linear-gradient(to right, #001089, #35e0f5)",
    },
...
const msgAgregarBoleto = () => {

Toastify({
  text: "Boleto agregado",
  duration: 3000,
  newWindow: true,
  close: true,
  gravity: "top", // `top` or `bottom`
...
const msgEliminarBoleto = () => {

  Toastify({
    text: "Boleto Eliminado",
    duration: 3000,
    newWindow: true,
    close: true,
    gravity: "top", // `top` or `bottom`
